...
noregparm INT
WIN_FUNC(_win_sprintf, 12)(char *buf, const char *format, ...)
{
        va_list args;
        int res;
        FMT_DECL(format)
...
noregparm INT
WIN_FUNC(_win_snprintf, 12)(char *buf, SIZE_T count, const char *format, ...)
{
        va_list args;
        int res;
        FMT_DECL(format)
...
__attribute__((format(printf, 3, 4)))
noregparm INT
WIN_FUNC(_win__snprintf, 12)(char *buf, SIZE_T count, const char *format, ...)
{
        va_list args;
        int res;
        FMT_DECL(format)
...
// api-ms-win-crt
regparm3 int WIN_FUNC(_initialize_onexit_table, 1)(void *table)
{
        return 0;
}

regparm3 int WIN_FUNC(_initterm_e, 2)(void *table, void *table2)
{
        return 0;
}

regparm3 int WIN_FUNC(_initterm, 2)(void *table, void *table2)
{
        return 0;
}

regparm3 int WIN_FUNC(strcpy_s, 2)(char *dest, size_t dest_size, const char *src)
{
        return strcpy(dest, src);
}

regparm3 __time64_t WIN_FUNC(_time64, 2)(__time64_t *timeptr)
{
...
noregparm HANDLE WIN_FUNC(_beginthreadex, 6)(void *security, size_t stacksize, void *func, void *args, size_t initflag, void *thrdaddr)
{
        pthread_t *pThread;
        pthread_attr_t attr;
